...
def predict_demand(req: DemandRequest):
    ...
    # NOTE: rolling_7/rolling_30 need real recent history for accuracy.
    # For a cold-start demo, we fall back to a reasonable default.
    # In production, pull the recipient's actual recent demand here.
