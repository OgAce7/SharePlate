...
def engineer_features(df):
    ...
    # rolling averages per recipient (past 7 and 30 days), shifted so we
    # never leak today's value into its own features
    df["rolling_7"] = (
    ...
    # fill early-history NaNs (first few days per recipient) with the
    # recipient's overall mean
